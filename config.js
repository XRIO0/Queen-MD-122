...
global.ownername = process.env.OWNER_NAME === undefined ? "Amrit Yadav " : process.env.OWNER_NAME
let fake = process.env.OWNER_NUMBER === undefined ? '8542063366' : process.env.OWNER_NUMBER
global.owner = [`${fake}`]
global.ownernumber = [`${fake}`]
global.premium = [`${fake}`]
global.anticall = process.env.ANTICALL === undefined ? 'false' : process.env.ANTICALL
global.packname = process.env.PACK_NAME === undefined ? 'chatbot' : process.env.PACK_NAME
global.author = process.env.STICKER_AUTHOR_NAME === undefined ? 'Amrit Yadav' : process.env.STICKER_AUTHOR_NAME
